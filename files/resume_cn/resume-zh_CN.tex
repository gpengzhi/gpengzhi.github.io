...
\item {C. Han, {\bf P. Gao}, P. Fu, and J. Luan. ``Reference-Free Post-Training of Open Large Language Models for Multilingual Machine Translation.'' \emph{arXiv: 2608.10812}, 2026.}
...
\item {T. Xiong, X. Hu, Y. Chen, Y. Liu, C. Wu, {\bf P. Gao}, W. Liu, J. Luan, and S. Zhang. ``GUI-PRA: Process Reward Agents for GUI Tasks.'' \emph{Proc. of the 2026 Conference on Empirical Methods in Natural Language Processing (EMNLP)}, 2026.}

\item {L. Zhang, Y. Chen, C. Zhang, W. Cao, K. Huang, {\bf P. Gao}, W. Liu, J. Luan, C. Li, and L. Zou. ``GSAR: Goal-State-Anchor Rewards for Mobile GUI Agents with Self-Evolving Data Synthesis.'' \emph{Proc. of the 2026 Conference on Empirical Methods in Natural Language Processing (EMNLP)}, 2026.}
